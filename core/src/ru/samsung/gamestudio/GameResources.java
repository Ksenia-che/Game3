...
public class GameResources {
    public static final String SHIP_IMG_PATH = "textures/ship.antivirus.png";
    public static final String TRASH_IMG_PATH = "textures/trash.virus.png";
    public static final String BULLET_IMG_PATH = "textures/bullet.png";
    public static final String BACKGROUND_IMG_PATH = "textures/background.bluescreen.png";
